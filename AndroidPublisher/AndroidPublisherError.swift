...
public enum GoogleCloudAndroidPublisherError: GoogleCloudError {
    ...
    var localizedDescription: String {
        switch self {
        case .projectIdMissing:
            return "Missing project id for GoogleCloudAndroidPublisher API. Did you forget to set your project id?"
...
public struct AndroidPublisherAPIError: GoogleCloudError, GoogleCloudModel {
    /// A container for the error information.
    public var error: AndroidPublisherAPIErrorBody
}

public struct AndroidPublisherAPIErrorBody: Codable {
...
public struct AndroidPublisherError: Codable {
